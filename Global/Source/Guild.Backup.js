...
class guildBackup {
    ...
    static async guildChannels() {
        ...
        if (guild) {
            ...
            await client._logger.log(`${tarihsel(Date.now())} tarihinde Kanal güncelleme işlemleri tamamlandı.`, "backup");
        }
    }
    ...
    static async guildRoles() {
        ...
        await client._logger.log(`${tarihsel(Date.now())} tarihinde Rol güncelleme işlemleri tamamlandı.`, "backup");
    };
